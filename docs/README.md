...
| Guide | Description |
|-------|-------------|
| [development.md](./development.md) | **Run locally** — localhost setup, env vars, commands |
...
| [srs/README.md](./srs/README.md) | **SRS** — product requirements (admin panel, password reset, …) |