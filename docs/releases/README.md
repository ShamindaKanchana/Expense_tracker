...
| Field | Value |
|-------|--------|
| **Version** | **[0.7.0](./v0.7.0.md)** |
| **Status** | Current |
| **Git tag** | [`v0.7.0`](https://github.com/ShamindaKanchana/Expense_tracker/releases/tag/v0.7.0) |
| **GitHub release** | [Expense Tracker v0.7.0](https://github.com/ShamindaKanchana/Expense_tracker/releases/tag/v0.7.0) |

## Release index

| Version | Date | Title | Compared to |
|---------|------|--------|-------------|
| [0.7.0](./v0.7.0.md) | 2026-09-14 | Trilingual voice expense input, configurable LLM extraction | 0.6.0 |
...
5. Optionally tag git: `git tag v0.4.0 && git push origin v0.4.0`.
